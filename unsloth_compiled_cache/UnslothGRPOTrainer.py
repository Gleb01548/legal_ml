...
from trl.trainer.grpo_trainer import (Any, AutoModelForCausalLM, AutoModelForSequenceClassification, AutoTokenizer, Dataset, GRPOConfig, GRPOTrainer, GenerationConfig, IterableDataset, Optional, PeftConfig, PreTrainedModel, PreTrainedTokenizerBase, RewardFunc, Trainer, TrainerCallback, Union, apply_chat_template, broadcast_object_list, create_reference_model, defaultdict, gather_object, generate_model_card, get_comet_experiment_url, is_conversational, is_deepspeed_zero3_enabled, is_wandb_available, maybe_apply_chat_template, os, pad, patch, prepare_deepspeed, textwrap, torch, transformers, unwrap_model_for_generation, version, warnings, GRPOTrainer, PreTrainedModel, Trainer, apply_chat_template, broadcast_object_list, gather_object, is_conversational, maybe_apply_chat_template, os, pad, torch, unwrap_model_for_generation)
...
class UnslothGRPOTrainer(_UnslothGRPOTrainer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        PatchRLStatistics('grpo_trainer')
